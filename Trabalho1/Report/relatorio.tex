...
\centering
\label{my-label}
\resizebox{\textwidth}{!}{\begin{tabular}{ll|l|l|l|l|l|lll}
\cline{2-7}
\multicolumn{1}{l|}{add \$3, \$2, \$1} & IF & ID1 & ID2 & EXE                         & MEM                         & WB  &                          &                          &                                                \\ \cline{2-10} 
add \$4, \$3, \$1                      &    & IF  & ID1 & \cellcolor[HTML]{F8A102}ID2 & \cellcolor[HTML]{F8A102}ID2 & ID2 & \multicolumn{1}{l|}{EXE} & \multicolumn{1}{l|}{MEM} & \multicolumn{1}{l|}{{\color[HTML]{333333} WB}} \\ \cline{3-10} 
\end{tabular}}
\end{table}
...
\centering
\label{my-label}
\resizebox{\textwidth}{!}{\begin{tabular}{lll|l|l|l|l|lll}
\cline{2-7}
\multicolumn{1}{l|}{add \$3, \$2, \$1} & \multicolumn{1}{l|}{IF} & ID1 & ID2 & EXE & MEM                                                & WB  &                          &                          &                         \\ \cline{2-8}
add \$0, \$0, \$0                      & \multicolumn{1}{l|}{}   & IF  & ID1 & ID2 & EXE                                                & MEM & \multicolumn{1}{l|}{WB}  &                          &                         \\ \cline{3-10} 
add \$4, \$3, \$1                      &                         &     & IF  & ID1 & \cellcolor[HTML]{F8A102}{\color[HTML]{000000} ID2} & ID2 & \multicolumn{1}{l|}{EXE} & \multicolumn{1}{l|}{MEM} & \multicolumn{1}{l|}{WB} \\ \cline{4-10} 
\end{tabular}}
\end{table}
